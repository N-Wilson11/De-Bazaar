                                ...
                                <tbody>
                                    @foreach($rentals as $rental)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $rental->views }}</td>                                            <td class="text-end">
                                                <div class="btn-group">
                                                    <a href="{{ route('advertisements.show', $rental) }}" class="btn btn-sm btn-info" title="{{ __('Bekijken') }}">
                                                        <i class="bi bi-eye"></i> <span class="d-none d-md-inline">{{ __('Bekijken') }}</span>
                                                    </a>
                                                    <a href="{{ route('advertisements.edit', $rental) }}" class="btn btn-sm btn-primary" title="{{ __('Bewerken') }}">
                                                        <i class="bi bi-pencil"></i> <span class="d-none d-md-inline">{{ __('Bewerken') }}</span>
                                                    </a>
                                                    <a href="{{ route('advertisements.calendar', $rental) }}" class="btn btn-sm btn-warning" title="{{ __('Kalender') }}">
